...
(
    ...
    permitir_matricula bool not null
)
ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
ALTER TABLE matricula ADD PRIMARY KEY(cui_estudiante, codigo_laboratorio);
ALTER TABLE matricula MODIFY cui_estudiante integer not null;
ALTER TABLE matricula MODIFY codigo_laboratorio integer not null;
