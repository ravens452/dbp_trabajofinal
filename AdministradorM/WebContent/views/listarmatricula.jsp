...
<body>
    ...
    <table BORDER=2 BORDERCOLOR=BLUE>
        ...
        <c:forEach var="matricula" items="${lista}">
            <tr>
                <td><c:out value="${matricula.codigo_laboratorio}"></c:out></td>
                ...
                <td> <a href="laboratorio?opcion=meditar&codigo_laboratorio=<c:out value="${laboratorio.id}"></c:out>"> <c:out value="${laboratorio.id}"></c:out>  </a> </td>
            </tr>
        </c:forEach>
    </table>
</body>