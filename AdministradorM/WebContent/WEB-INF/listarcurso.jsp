...
<link rel="stylesheet" href="css/listarcurso.css">
</head>
<body>
<div class="box">
    ...
    <table BORDER=2 BORDERCOLOR=BLUE class="center">
        <tr>
            <td style="color:#9ee000;" > <a style="color:#9ee000;">Codigo del Curso</td>
            <td style="color:#9ee000;" > <a style="color:#9ee000;">Nombre del Curso</td>
            <td style="color:#9ee000;" > <a style="color:#9ee000;">Descripcion</td>
        </tr>
